    ...
    <div class="container">
      ...
      <div class="certs__grid">
        ...
        <div class="cert-card cert-card--completed">
          ...
          <div class="cert-card__logo cert-card__logo--outskill">
            <span>OS</span>
          </div>
        ...
        <div class="cert-card cert-card--inprogress">
          <div class="cert-card__logo cert-card__logo--datacamp">
            <span>DC</span>
          </div>
          <div class="cert-card__body">
            <h3>Data Analytics</h3>
            <p class="cert-card__issuer">DataCamp</p>
            <p class="cert-card__desc">Hands-on data analytics training covering data manipulation, visualization, statistical analysis, and Python for data science workflows.</p>
          </div>
          <div class="cert-card__footer">
        ...
        <div class="cert-card cert-card--inprogress">
          <div class="cert-card__logo cert-card__logo--microsoft">
            <span>MS</span>
          </div>
          <div class="cert-card__body">
        ...
        <div class="cert-card cert-card--inprogress">
          <div class="cert-card__logo cert-card__logo--ibm">
            <span>IBM</span>
          </div>
          <div class="cert-card__body">
...
.scroll-line {
  width: 1px;
  height: 40px;
  background: linear-gradient(to bottom, var(--c-pink), transparent);
...
.timeline::before {
  ...
  width: 2px;
  background: linear-gradient(to bottom, var(--c-pink), var(--c-blue), transparent);
}
...
.cert-card--completed {
  ...
  background: linear-gradient(135deg, rgba(76,201,240,0.05), var(--bg-card));
}
...
@media (max-width: 480px) {
  ...
  .edu__gpa { position: static; margin-top: 8px; }
}
...
git add .
git commit -m "Add personal resume page for Tammy S. Miller"
git push -u origin TechTam/create-resume-page-bdYGN

Write-Host "Done! Branch pushed. Now open a PR on GitHub to merge into main." -ForegroundColor Green
